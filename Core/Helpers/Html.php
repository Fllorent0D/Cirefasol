...
class Html
{
    ...
    public static function cssLibray($name)
    {
        return "<link rel='stylesheet' type='text/css' href='" . WEBROOT . "libraries" . DS . "$name.css' media='screen' title='Normal' />";
    }
    public static function jsLibray($name)
    {
        return "<link type='text/javascript' href='" . WEBROOT . "libraries" . DS . "$name.js' />";
    }
    /**
     * Génère un lien js
     * @param $name
